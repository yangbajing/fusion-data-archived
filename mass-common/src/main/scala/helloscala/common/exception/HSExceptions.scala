...
case class HSAcceptedWarning(errMsg: String,
                             data: AnyRef = null,
...
case class HSBadRequestException(errMsg: String,
                                 data: AnyRef = null,
...
case class HSUnauthorizedException(errMsg: String,
                                   data: AnyRef = null,
...
case class HSNoContentException(errMsg: String,
                                data: AnyRef = null,
...
case class HSForbiddenException(errMsg: String,
                                data: AnyRef = null,
...
case class HSNotFoundException(errMsg: String,
                               data: AnyRef = null,
...
case class HSConfigurationException(errMsg: String,
                                    data: AnyRef = null,
...
case class HSConflictException(errMsg: String,
                               data: AnyRef = null,
...
case class HSNotImplementedException(errMsg: String,
                                     data: AnyRef = null,
...
case class HSInternalErrorException(errMsg: String,
                                    data: AnyRef = null,
