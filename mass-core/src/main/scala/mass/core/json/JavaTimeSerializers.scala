...
object JavaTimeSerializers {
  ...
  object InstantSerializer
      extends InstantSerializer(DateTimeFormatter.ISO_INSTANT)

  /** The default `LocalTimeSerializer` for ISO-8601 strings. */
  object LocalTimeSerializer
      extends LocalTimeSerializer(DateTimeFormatter.ISO_LOCAL_TIME)
  ...
  class InstantSerializer private[JavaTimeSerializers] (
  ...
  class LocalTimeSerializer private[JavaTimeSerializers] (
      val format: DateTimeFormatter)
  ...
  class LocalDateTimeSerializer private[JavaTimeSerializers] (
      val format: DateTimeFormatter)
  ...
  class ZonedDateTimeSerializer private[JavaTimeSerializers] (
      val format: DateTimeFormatter)
  ...
  class OffsetDateTimeSerializer private[JavaTimeSerializers] (
      val format: DateTimeFormatter)
