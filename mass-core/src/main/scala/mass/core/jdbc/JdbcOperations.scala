...
trait JdbcOperations {
  ...
  def batchUpdate(
      sql: String,
      argsList: java.util.Collection[java.util.Collection[Object]]): Array[Int]
  ...
  /**
    ...
    * @return 受影响的数据库行数量
    */
  def update(sql: String, args: Iterable[Any])(
  ...
  /**
    ...
    * @return 匹配条件的记录行数量
    */
  def size(sql: String, args: Seq[Any])(implicit connection: Connection =
                                          JdbcTemplate.EmptyConnection): Long
  ...
  def listForMap(
      sql: String,
      args: Seq[Any])(implicit connection: Connection =
                        JdbcTemplate.EmptyConnection): List[Map[String, Object]]
  ...
  def namedListForObject[R](sql: String,
                            args: Map[String, Any],
                            rowMapper: ResultSet => R)(
      implicit connection: Connection = JdbcTemplate.EmptyConnection): List[R]

  def findForMap(sql: String, args: Seq[Any])(implicit connection: Connection =
  ...
  def namedFindForObject[R](sql: String,
                            args: Map[String, Any],
                            rowMapper: ResultSet => R)(
      implicit connection: Connection = JdbcTemplate.EmptyConnection): Option[R]
  ...
  def execute[R](externalConn: Connection,
